	...
	<option<?=$country == 'Aberdeen' ? ' selected="selected"' : '' ;?> value="Aberdeen">Aberdeen</option>
	<option<?=$country == 'Cairo' ? ' selected="selected"' : '' ;?> value="Cairo">Cairo</option>
	<option<?=$country == 'Dubai' ? ' selected="selected"' : '' ;?> value="Dubai">Dubai</option>
	<option<?=$country == 'Lagos' ? ' selected="selected"' : '' ;?> value="Lagos">Lagos</option>
	<option<?=$country == 'London' ? ' selected="selected"' : '' ;?> value="London">London</option>
	<option<?=$country == 'Malaysia' ? ' selected="selected"' : '' ;?> value="Malaysia">Malaysia</option>
	<option<?=$country == 'Turkey' ? ' selected="selected"' : '' ;?> value="Turkey">Turkey</option>
	<option<?=$country == 'United Kingdom' ? ' selected="selected"' : '' ;?> value="United Kingdom">United Kingdom</option>

	<option<?=$country == '-------' ? ' selected="selected"' : '' ;?> value="-------">-------</option>
